...
function hospice_css_alter(&$css) {
  unset($css[drupal_get_path('module', 'nice_menus') . '/css/nice_menus_default.css']);
}
/*
function orchardhill_preprocess_html(&$variables) {
  $theme_path = path_to_theme();
  $path = drupal_get_path_alias();
  if($path == 'home') {
      drupal_add_js($theme_path . '/assets/royalslider/jquery.royalslider.min.js');
      drupal_add_js($theme_path . '/assets/royalslider/slider.js');
      drupal_add_css($theme_path . '/assets/royalslider/royalslider.css');
      drupal_add_css($theme_path . '/assets/royalslider/skins/minimal-white/rs-minimal-white.css');
    }
  }
  */

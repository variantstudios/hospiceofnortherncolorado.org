...
<script type="text/javascript" src="//use.typekit.net/xms7pld.js"></script>
<script type="text/javascript">try{Typekit.load();}catch(e){}</script>


    <!--[if lt IE 9]><script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'hospice'); ?>/htmlshim/dist/html5shiv.js"></script><![endif]-->
<!--[if lt IE 9]>
    	<link rel="stylesheet" type="text/css" href="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'hospice'); ?>/assets/css/no-mq.css" />
    <![endif]-->      
  </head>
